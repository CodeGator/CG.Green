...
/// <summary>
/// This class is a view-model for creating a new super administrator account.
/// </summary>
public class NewSuperAdminVM
{
    // *******************************************************************
    // Properties.
    // *******************************************************************
    ...
    /// <summary>
    /// This property contains the newly created user.
    /// </summary>
    public GreenUser? User { get; set; }
