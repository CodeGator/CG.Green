...
/// <summary>
/// This class is the code-behind for the <see cref="NewClaimDialog"/> dialog.
/// </summary>
public partial class NewClaimDialog
{
    // *******************************************************************
    // Properties.
    // *******************************************************************
    ...
    /// </summary>
    [Parameter]
    public NewClaimVM Model { get; set; } = null!;
    ...
    /// </summary>
    [Inject]
    protected ILogger<NewClaimDialog> Logger { get; set; } = null!;
