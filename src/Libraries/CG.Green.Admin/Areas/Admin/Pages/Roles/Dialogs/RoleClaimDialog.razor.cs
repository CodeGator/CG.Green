...
/// <summary>
/// This class is the code-behind for the <see cref="RoleClaimDialog"/> dialog.
/// </summary>
public partial class RoleClaimDialog
{
	...
	/// </summary>
	[Parameter]
	public GreenRoleClaim Model { get; set; } = null!;
	...
	/// </summary>
	[Inject]
	protected ILogger<RoleClaimDialog> Logger { get; set; } = null!;
