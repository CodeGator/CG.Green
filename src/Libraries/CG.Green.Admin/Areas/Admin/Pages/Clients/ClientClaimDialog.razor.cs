...
/// <summary>
/// This class is the code-behind for the <see cref="ClientClaimDialog"/> dialog.
/// </summary>
public partial class ClientClaimDialog
{
	// *******************************************************************
	// Properties.
	// *******************************************************************
	...
	/// </summary>
	[Parameter]
	public ClientClaimVM Model { get; set; } = null!;
	...
	/// </summary>
	[Inject]
	protected IStringLocalizer<ClientClaimDialog> Localizer { get; set; } = null!;

	/// <summary>
	/// This property contains the logger for this dialog.
	/// </summary>
	[Inject]
	protected ILogger<ClientClaimDialog> Logger { get; set; } = null!;
