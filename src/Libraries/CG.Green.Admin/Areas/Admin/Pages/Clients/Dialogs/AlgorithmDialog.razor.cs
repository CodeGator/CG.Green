...
/// <summary>
/// This class is the code-behind for the <see cref="AlgorithmDialog"/> dialog.
/// </summary>
public partial class AlgorithmDialog
{
    // *******************************************************************
    // Properties.
    // *******************************************************************
    ...
    /// </summary>
    [Inject]
    protected IStringLocalizer<AlgorithmDialog> Localizer { get; set; } = null!;

    /// <summary>
    /// This property contains the logger for this dialog.
    /// </summary>
    [Inject]
    protected ILogger<AlgorithmDialog> Logger { get; set; } = null!;
