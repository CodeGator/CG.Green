...
/// <summary>
/// This class is the code-behind for the <see cref="ClientPkcePanel"/> component.
/// </summary>
public partial class ClientPkcePanel
{
	// *******************************************************************
	// Fields.
	// *******************************************************************
	...
	/// </summary>
	[Inject]
	protected IStringLocalizer<ClientPkcePanel> Localizer { get; set; } = null!;
	...
	/// </summary>
	[Inject]
	protected ILogger<ClientPkcePanel> Logger { get; set; } = null!;
