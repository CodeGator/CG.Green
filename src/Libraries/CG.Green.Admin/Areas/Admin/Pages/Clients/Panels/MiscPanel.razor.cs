...
/// <summary>
/// This class is the code-behind for the <see cref="MiscPanel"/> component.
/// </summary>
public partial class MiscPanel
{
	// *******************************************************************
	// Fields.
	// *******************************************************************
	...
	/// </summary>
	[Inject]
	protected IStringLocalizer<MiscPanel> Localizer { get; set; } = null!;
	...
	/// </summary>
	[Inject]
	protected ILogger<MiscPanel> Logger { get; set; } = null!;
