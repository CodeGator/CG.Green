...
/// <summary>
/// This class is the code-behind for the <see cref="ClientClaimsPanel"/> component.
/// </summary>
public partial class ClientClaimsPanel
{
	// *******************************************************************
	// Fields.
	// *******************************************************************
	...
	/// </summary>
	[Inject]
	protected ILogger<ClientClaimsPanel> Logger { get; set; } = null!;
