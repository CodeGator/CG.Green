...
/// <summary>
/// This class is the code-behind for the <see cref="ConsentPanel"/> component.
/// </summary>
public partial class ConsentPanel
{
	// *******************************************************************
	// Fields.
	// *******************************************************************
	...
	/// </summary>
	[Inject]
	protected IStringLocalizer<ConsentPanel> Localizer { get; set; } = null!;
	...
	/// </summary>
	[Inject]
	protected ILogger<ConsentPanel> Logger { get; set; } = null!;
