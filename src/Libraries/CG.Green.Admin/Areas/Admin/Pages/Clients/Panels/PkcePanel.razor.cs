...
/// <summary>
/// This class is the code-behind for the <see cref="PkcePanel"/> component.
/// </summary>
public partial class PkcePanel
{
	// *******************************************************************
	// Fields.
	// *******************************************************************
	...
	/// </summary>
	[Inject]
	protected IStringLocalizer<PkcePanel> Localizer { get; set; } = null!;
	...
	/// </summary>
	[Inject]
	protected ILogger<PkcePanel> Logger { get; set; } = null!;
