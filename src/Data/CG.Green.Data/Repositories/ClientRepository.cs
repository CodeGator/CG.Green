...
internal class ClientRepository : IClientRepository
{
        ...
        )
    {
        ...
        try
        {
			...
			entity.AbsoluteRefreshTokenLifetime = clientEntity.AbsoluteRefreshTokenLifetime;	
			entity.AccessTokenLifetime= clientEntity.AccessTokenLifetime;
			entity.AccessTokenType = clientEntity.AccessTokenType;	
			entity.AllowAccessTokensViaBrowser = clientEntity.AllowAccessTokensViaBrowser;	
			entity.AllowedCorsOrigins = clientEntity.AllowedCorsOrigins;
            entity.AllowedGrantTypes = clientEntity.AllowedGrantTypes;    
			entity.AllowedIdentityTokenSigningAlgorithms = clientEntity.AllowedIdentityTokenSigningAlgorithms;
			entity.AllowedScopes = clientEntity.AllowedScopes;
			entity.AllowOfflineAccess = clientEntity.AllowOfflineAccess;
			entity.AllowPlainTextPkce = clientEntity.AllowPlainTextPkce;	
			entity.AllowRememberConsent = clientEntity.AllowRememberConsent;
			...
			entity.AuthorizationCodeLifetime = clientEntity.AuthorizationCodeLifetime;	
			entity.BackChannelLogoutSessionRequired = clientEntity.BackChannelLogoutSessionRequired;	
			entity.BackChannelLogoutUri = clientEntity.BackChannelLogoutUri;
			entity.CibaLifetime = clientEntity.CibaLifetime;	
			...
			entity.ClientUri = clientEntity.ClientUri;	
			entity.ConsentLifetime = clientEntity.ConsentLifetime;	
			entity.CoordinateLifetimeWithUserSession = clientEntity.CoordinateLifetimeWithUserSession;
			entity.Description = clientEntity.Description;
			entity.DeviceCodeLifetime = clientEntity.DeviceCodeLifetime;
			entity.Enabled = clientEntity.Enabled;
			entity.EnableLocalLogin = clientEntity.EnableLocalLogin;
			entity.FrontChannelLogoutSessionRequired = clientEntity.FrontChannelLogoutSessionRequired;
			entity.FrontChannelLogoutUri = clientEntity.FrontChannelLogoutUri;
			entity.IdentityProviderRestrictions = clientEntity.IdentityProviderRestrictions;	
			entity.IdentityTokenLifetime = clientEntity.IdentityTokenLifetime;	
			entity.IncludeJwtId = clientEntity.IncludeJwtId;	
			entity.LogoUri = clientEntity.LogoUri;
			entity.PairWiseSubjectSalt = clientEntity.PairWiseSubjectSalt;
			entity.PollingInterval = clientEntity.PollingInterval;
			entity.PostLogoutRedirectUris = clientEntity.PostLogoutRedirectUris;
			entity.Properties = clientEntity.Properties;	
			entity.ProtocolType = clientEntity.ProtocolType;
			entity.RedirectUris = clientEntity.RedirectUris;
			entity.RefreshTokenExpiration = clientEntity.RefreshTokenExpiration;	
			entity.RefreshTokenUsage = clientEntity.RefreshTokenUsage;
			entity.RequireClientSecret = clientEntity.RequireClientSecret;
			entity.RequireConsent = clientEntity.RequireConsent;
			entity.RequirePkce = clientEntity.RequirePkce;
			entity.RequireRequestObject = clientEntity.RequireRequestObject;    
			entity.SlidingRefreshTokenLifetime = clientEntity.SlidingRefreshTokenLifetime;
			entity.UpdateAccessTokenClaimsOnRefresh = clientEntity.UpdateAccessTokenClaimsOnRefresh;
			entity.UserCodeType = clientEntity.UserCodeType;	
			entity.UserSsoLifetime = clientEntity.UserSsoLifetime;
