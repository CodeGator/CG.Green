...
/// type.
/// </summary>
public static class WebApplicationExtensions003
{
    // *******************************************************************
    // Public methods.
    // *******************************************************************
    ...
    /// <summary>
    /// This method drops and recreates the database for the <see cref="CG.Green"/>
    /// microservice.
    /// </summary>
    /// <param name="webApplication">The web application to use for the 
    /// operation.</param>
        ...
        )
    {
        ...
        webApplication.Logger.LogTrace(
            "Deferring to {name}",
            nameof(WebApplicationExtensions003.MigrateDatabaseAsync)
            );
    ...
    /// <summary>
    /// This method migrates the various data-contexts in the <see cref="CG.Green"/>
    /// microservice.
    /// </summary>
    /// <param name="webApplication">The web application to use for the 
    /// operation.</param>
